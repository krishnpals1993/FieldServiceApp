  ...
  var Basic = /*#__PURE__*/function () {
    ...
    _createClass(Basic, null, [{
      ...
      value: function _handleDropdowns() {
        ...
        $(document).on('shown.bs.dropdown', '.dropdown.dd-backdrop', function (e) {
  ...
  var Sidebar = /*#__PURE__*/function () {
    ...
    _createClass(Sidebar, [{
      ...
      value: function _toggleMobileCompleted() {
        ...
        if (shown) $(this._sidebar).trigger(Event$1.SHOWN);else {
          ...
          $(this._sidebar).trigger(Event$1.HIDDEN);
        }
      }
    }, {
      ...
      value: function enableSwipeHide() {
        ...
        $(document).on('touchstart.sidebar-swipe', function (e) {
          ...
          $(document).on('touchmove.sidebar-swipe', function (e) {
    ...
    _createClass(Aside, [{
      ...
      value: function _jQueryInterface(config) {
        return this.each(function () {
          ...
          var _config = _objectSpread2(_objectSpread2(_objectSpread2({}, Default$2), $(this).data()), _typeof(config) === 'object' && config ? config : {});
    ...
    _createClass(Toaster, [{
      ...
      value: function add(config) {
        ...
        if (_config.progress && !_config.sticky && _config.autohide !== false) {
          var progress = $("<div class=\"toast-progress ".concat(_config.progress, "\"></div>")).appendTo($newToast);
